...
urlpatterns = [
    ...
    path('activity_project/<int:pk>/', views.ProjectActivityView.as_view(), name='activity-project'),
    path('payments_project/<int:pk>/', views.ProjectPaymentsView.as_view(), name='payments-project'),
    path('files_project/<int:pk>/', views.ProjectFilesView.as_view(), name='files-project'),
    path('create_project_file/<int:pk>/', views.ProjectFilesCreateView.as_view(), name='create-project-file'),
    path('create_project_file_c/<int:pk>/', views.ProjectFilesClientCreateView.as_view(), name='create-project-file-c'),
    path('project/<int:project_id>/detail_project_file/<int:pk>/', views.ProjectFilesDetailView.as_view(),
         name='detail-project-file'),
    path('update_project_file/<int:pk>/', views.ProjectFilesUpdateView.as_view(), name='update-project-file'),
